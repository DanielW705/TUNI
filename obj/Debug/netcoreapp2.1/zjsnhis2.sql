...
CREATE TABLE [historialrechazos] (
    [noderechazo] int NOT NULL IDENTITY,
    [idUniversidad] uniqueidentifier NOT NULL,
    [idAlumno] uniqueidentifier NOT NULL,
    CONSTRAINT [PK_historialrechazos] PRIMARY KEY ([noderechazo])
);
...
VALUES ('328bead2-c66d-4bf2-a655-b59d4367ef35', N'123aEFGJnfsa', N'ADMINISTRADOR 1'),
('08b3edc3-3721-4470-ab48-a0eb18cebf9f', N'aggvkKBQ5hp', N'ADMINISTRADOR 2'),
('1e5519db-843c-4cc7-b35d-a041f59497ef', N'HzmJlaLKU1f', N'ADMINISTRADOR 3'),
('535bc45d-5d7c-4649-b85d-ebcc38d4fca7', N'Xmxg82RTiuQV', N'ADMINISTRADOR 4'),
('32b2782f-2cf9-474f-a00f-31e1d4267f49', N'bgTR1apIK1ye', N'ADMINISTRADOR 5');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'idAmon', N'contraseña', N'username') AND [object_id] = OBJECT_ID(N'[Administradores]'))
...
VALUES (N'20200610024305_1', N'2.1.14-servicing-32113');

...
VALUES ('6e1f3430-adfd-4f73-adfc-086ee5aa950e', N'123a', N'ADMINISTRADOR 1');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'idAmon', N'contraseña', N'username') AND [object_id] = OBJECT_ID(N'[Administradores]'))
...
VALUES (9, N'Mecanico Constructivo'),
(8, N'Calculo'),
(7, N'Cientifica'),
(6, N'Organizacion'),
(5, N'Musical'),
...
VALUES (N'20200526204536_1', N'2.1.14-servicing-32113');

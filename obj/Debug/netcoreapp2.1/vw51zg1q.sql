...
GO
            ...
            insert into  Relaciones select car.idAlumno, ci.usuarioUniversidad from carrerasDeseadas car inner join carrerasImpartadas ci on car.idCarrera = ci.catCarrerasId where car.idAlumno = @idalumno
            END

    ...
    public partial class _1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idCarrera = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    idArea = table.Column<int>(nullable: false),
                    carreraImpartida = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_catCarreras", x => x.idCarrera);
                    table.ForeignKey(
                        name: "Relacion_areac_carrera",
                        column: x => x.idArea,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idCarreTecnicas = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_catalogoCarrerasT", x => x.idCarreTecnicas);
                    table.ForeignKey(

...
CREATE TABLE [catCarreras] (
    ...
    [relcarr_carrinoderelacion] int NULL,
    ...
    CONSTRAINT [FK_catCarreras_carrerasImpartadas_relcarr_carrinoderelacion] FOREIGN KEY ([relcarr_carrinoderelacion]) REFERENCES [carrerasImpartadas] ([noderelacion]) ON DELETE NO ACTION
);
...
CREATE INDEX [IX_catCarreras_relcarr_carrinoderelacion] ON [catCarreras] ([relcarr_carrinoderelacion]);
...
VALUES (N'20200523213903_1', N'2.1.14-servicing-32113');

...
CREATE TABLE [pregintasDelTestVocacional] (
    [PregunataId] int NOT NULL IDENTITY,
    [areasTestId] int NOT NULL,
    [pregunta] nvarchar(max) NULL,
    CONSTRAINT [PK_pregintasDelTestVocacional] PRIMARY KEY ([PregunataId]),
    CONSTRAINT [FK_pregintasDelTestVocacional_AreasTests_areasTestId] FOREIGN KEY ([areasTestId]) REFERENCES [AreasTests] ([areaTestId]) ON DELETE CASCADE
);
...
CREATE INDEX [IX_pregintasDelTestVocacional_areasTestId] ON [pregintasDelTestVocacional] ([areasTestId]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200518185246_1', N'2.1.14-servicing-32113');

...
VALUES (N'20200524032118_1', N'2.1.14-servicing-32113');
...
GO
 ...
 CREATE PROCEDURE Realizarcalculodeltest
                                    ...
                                    select* from @query
                                    select ida ,idCarrera from @query q inner join catCarreras cat on q.area = cat.areasTestId
                                    END

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200525182241_d', N'2.1.14-servicing-32113');

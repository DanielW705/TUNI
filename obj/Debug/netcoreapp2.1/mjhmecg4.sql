...
VALUES ('e6290faa-6565-4908-9b85-49837c944b3b', N'123aEFGJnfsa', N'ADMINISTRADOR 1');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'idAmon', N'contraseña', N'username') AND [object_id] = OBJECT_ID(N'[Administradores]'))
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'idAlumno', N'contraseña', N'usuario') AND [object_id] = OBJECT_ID(N'[alumnosUsuarios]'))
    SET IDENTITY_INSERT [alumnosUsuarios] ON;
INSERT INTO [alumnosUsuarios] ([idAlumno], [contraseña], [usuario])
VALUES ('b57e9925-5ed0-4cac-76b0-08d8064770fe', N'Ae129%dsa', N'Daniel');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'idAlumno', N'contraseña', N'usuario') AND [object_id] = OBJECT_ID(N'[alumnosUsuarios]'))
    SET IDENTITY_INSERT [alumnosUsuarios] OFF;
...
VALUES (3, N'Ciencias Sociales y administrativas'),
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'idAlumno', N'apMaterno', N'apPaterno', N'nombre') AND [object_id] = OBJECT_ID(N'[alumnos]'))
    SET IDENTITY_INSERT [alumnos] ON;
INSERT INTO [alumnos] ([idAlumno], [apMaterno], [apPaterno], [nombre])
VALUES ('b57e9925-5ed0-4cac-76b0-08d8064770fe', N'Martinez', N'Gonzalez', N'Daniel');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'idAlumno', N'apMaterno', N'apPaterno', N'nombre') AND [object_id] = OBJECT_ID(N'[alumnos]'))
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'noDePregunta', N'areasTestID', N'idAlumno', N'idPregunta', N'valor') AND [object_id] = OBJECT_ID(N'[valorPreguntas]'))
    SET IDENTITY_INSERT [valorPreguntas] ON;
INSERT INTO [valorPreguntas] ([noDePregunta], [areasTestID], [idAlumno], [idPregunta], [valor])
VALUES (35, 5, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 35, 5),
(34, 4, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 34, 0),
(33, 3, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 33, 5),
(32, 2, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 31, 0),
(27, 7, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 27, 5),
(30, 10, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 30, 0),
(29, 9, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 29, 5),
(28, 8, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 28, 0),
(36, 6, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 36, 0),
(31, 1, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 31, 5),
(37, 7, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 37, 5),
(41, 1, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 41, 5),
(39, 9, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 39, 5),
(40, 10, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 40, 0),
(26, 6, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 26, 0),
(42, 2, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 42, 0),
(43, 3, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 43, 5),
(44, 4, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 44, 0),
(45, 5, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 45, 5),
(46, 6, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 46, 0),
(47, 7, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 47, 5),
(48, 8, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 48, 0),
(38, 8, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 38, 0),
(25, 5, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 25, 5),
(21, 1, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 21, 5),
(23, 3, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 23, 5),
(1, 1, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 1, 5),
(2, 2, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 2, 0),
(3, 3, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 3, 5),
(4, 4, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 4, 0),
(5, 5, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 5, 5),
(6, 6, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 6, 0),
(7, 7, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 7, 5),
(8, 8, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 8, 0),
(9, 9, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 9, 5),
(10, 10, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 10, 0),
(24, 4, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 24, 0),
(11, 1, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 11, 5),
(13, 3, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 13, 5),
(14, 4, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 14, 0),
(15, 5, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 15, 5),
(16, 6, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 16, 0),
(17, 7, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 17, 5),
(18, 8, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 18, 0),
(19, 9, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 19, 5),
(20, 10, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 20, 0),
(49, 9, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 49, 5),
(22, 2, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 22, 0),
(12, 2, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 12, 0),
(50, 10, 'b57e9925-5ed0-4cac-76b0-08d8064770fe', 50, 0);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'noDePregunta', N'areasTestID', N'idAlumno', N'idPregunta', N'valor') AND [object_id] = OBJECT_ID(N'[valorPreguntas]'))
    SET IDENTITY_INSERT [valorPreguntas] OFF;
...
VALUES (N'20200605003719_1', N'2.1.14-servicing-32113');

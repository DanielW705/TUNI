...
CREATE TABLE [carrerasImpartadas] (
    ...
    CONSTRAINT [FK_carrerasImpartadas_catCarreras_catCarrerasId] FOREIGN KEY ([catCarrerasId]) REFERENCES [catCarreras] ([idCarrera]) ON DELETE CASCADE,
...
VALUES (N'20200524023546_1', N'2.1.14-servicing-32113');

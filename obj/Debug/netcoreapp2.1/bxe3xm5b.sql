...
CREATE TABLE [catCarreras] (
    ...
    CONSTRAINT [Relacion_carrera_areaTest] FOREIGN KEY ([areasTestId]) REFERENCES [AreasTests] ([areaTestId]) ON DELETE CASCADE
);
...
CREATE UNIQUE INDEX [IX_catCarreras_areasTestId] ON [catCarreras] ([areasTestId]);
...
VALUES (N'20200518175034_1', N'2.1.14-servicing-32113');

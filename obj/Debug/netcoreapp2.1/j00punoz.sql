...
CREATE TABLE [catCarreras] (
    ...
    CONSTRAINT [relacion_Areas_Con_Carrera] FOREIGN KEY ([idArea]) REFERENCES [catAreasCarrera] ([idArea]) ON DELETE CASCADE
);
...
CREATE INDEX [IX_catCarreras_idArea] ON [catCarreras] ([idArea]);
...
VALUES (N'20200518172253_1', N'2.1.14-servicing-32113');
